...
the Constitution, not this summary, are authoritative for status and scope. The
Knowledge Asset Architecture is subordinate to those authorities and governs
later knowledge-asset design; it creates no implementation contract.
