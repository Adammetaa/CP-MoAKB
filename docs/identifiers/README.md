...
- **Canonical master data:** the [Master Data Foundation](../master-data/README.md) applies identity governance to future bounded entity and relationship records; Sprint-015 mints no identifiers.
