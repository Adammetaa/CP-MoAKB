...
- **Vocabulary governance:** [Controlled Vocabulary Governance](../vocabulary/README.md) defines how future labels, definitions, synonyms, language forms, reviews, and releases can be governed without creating vocabulary content or redefining ontology meaning.
- **Canonical master data:** the [Master Data Foundation](../master-data/README.md) defines how later bounded datasets may instantiate approved concepts and relationships without treating ontology proposals as records or facts.
