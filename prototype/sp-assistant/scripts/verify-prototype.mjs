...
for (const required of ["name=\"login_id\"","capture=\"environment\" data-chat-camera","📷 เพิ่มรูป","governedRuntime.captureStatement(text","serverWorkspace.logout()","captureOnly()"] ) if (!fieldApp.includes(required)) failures.push(`field-app.js missing mobile capture workflow: ${required}`);
