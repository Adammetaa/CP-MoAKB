...
export class InvestigationIntelligenceEngine {
  constructor({ruleProvider=new PersistedCandidateRuleProvider(),candidateProvider=loadCandidateProvider(),clock=()=>new Date()}={}){this.ruleProvider=ruleProvider;this.candidateProvider=candidateProvider;this.clock=clock;}
  assess(bundle){
...
export class InvestigationIntelligenceService {
  constructor(db,bundleProvider,{ruleProvider=new PersistedCandidateRuleProvider(),candidateProvider=loadCandidateProvider(),clock=()=>new Date(),idProvider=()=>randomUUID()}={}){this.db=db;this.bundleProvider=bundleProvider;this.clock=clock;this.idProvider=idProvider;this.engine=new InvestigationIntelligenceEngine({ruleProvider,candidateProvider,clock});}
