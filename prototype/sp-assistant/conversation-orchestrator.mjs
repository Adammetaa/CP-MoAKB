...
export const CONVERSATION_ENUMS = Object.freeze({
  ...
  intents: ["FIELD_OBSERVATION", "FIELD_STATUS_UPDATE", "QUESTION", "VISUAL_CHECK", "GUIDANCE_RESPONSE", "CASE_FOLLOW_UP", "FOLLOW_UP_SCHEDULING", "REMINDER_ACTION", "CONTEXT_SELECTION", "USER_HYPOTHESIS", "MANAGEMENT_QUERY", "MANAGEMENT_SELECTION", "ACTION_CONFIRMATION", "OUTCOME_REPORT", "KNOWLEDGE_QUERY", "NAVIGATION_REQUEST", "SOCIAL_OR_OTHER"],
...
function localInterpretation(message, input) {
  ...
  let intent = /รับทราบเตือน|ปิดเตือน|ทำรายการติดตามนี้แล้ว|ยกเลิกเตือน|เลิกเตือน/iu.test(message) ? "REMINDER_ACTION" : /เตือน(?:ฉัน|ผม|เรา)?|กลับมาดูอีก|นัดติดตาม/iu.test(message) ? "FOLLOW_UP_SCHEDULING" : /ทำแล้ว|ดำเนินการแล้ว|ลงมือแล้ว/iu.test(message) ? "ACTION_CONFIRMATION" : /ดีขึ้น|น้อยลง|ลดลง|มากขึ้น|เพิ่มขึ้น|แย่ลง|เท่าเดิม|ไม่เปลี่ยน/iu.test(message) ? "OUTCOME_REPORT" : /(?:เลือก|เอา)(?:ทาง|ตัวเลือก)|ติดตามต่อ|ขอผู้เชี่ยวชาญ|ยังไม่ทำตอนนี้/iu.test(message) ? "MANAGEMENT_SELECTION" : /ยา|สารเคมี|พ่น|กำจัด|ใช้สาร|โดส|อัตรา|ทางเลือก|จัดการ|ทำอะไรได้บ้าง/iu.test(message) ? "MANAGEMENT_QUERY" : input.image_evidence_id || /ถ่ายแบบนี้|ดูรูป|ดูภาพ|รูปนี้|ภาพนี้/iu.test(message) ? "VISUAL_CHECK" : facts.length ? "FIELD_OBSERVATION" : userHypothesis ? "USER_HYPOTHESIS" : /ความรู้|คืออะไร|ทั่วไป/iu.test(message) ? "KNOWLEDGE_QUERY" : /เปิด|ไปหน้า/iu.test(message) ? "NAVIGATION_REQUEST" : /ขอบคุณ|สวัสดี/iu.test(message) ? "SOCIAL_OR_OTHER" : "QUESTION";
